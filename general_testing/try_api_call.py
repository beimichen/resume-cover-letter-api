...
json_object = {}
json_object['candidate_name'] = "anne laura"
json_object['hiring_manager_name'] = "John Doe"
json_object['job_title'] = "software developer"
json_object['job_ad_description'] = "Once upon a time there was a job"
json_object['company_name'] = "Microsoft"
json_object['resume_file'] = None
# handle resume file - ingest data, add sentences to resume later on etc
json_object['parsed_resume'] = {
        "first_name": "Camille",
        "middle_name": "Reubens",
        "last_name": "Moore",
...
response = requests.post(BASE + "/api/coverletter/create_coverletter", json=json_object)
...
# print(response.json())
# response = requests.get(BASE + "helloworld2/tim/19")
# print(response.json())
# response = requests.put(BASE + "video/1", {'name': 'qwe', 'views': 122, 'likes': 10})
# print(response.json())
#
# response = requests.get(BASE + "video/1")
# print(response.json())

# response = requests.patch(BASE + "video/1", {"views":2, "likes":101010})
# print(response.json())
